...
export const mockDocumentCategories = [
  { id: 1, name: "Site & Real Estate", code: "SITE", sortOrder: 1 },
  { id: 2, name: "Permits & Approvals", code: "PERMITS", sortOrder: 2 },
  { id: 3, name: "Technical", code: "TECH", sortOrder: 3 },
  { id: 4, name: "Interconnection", code: "INTERCON", sortOrder: 4 },
  { id: 5, name: "Financial", code: "FIN", sortOrder: 5 },
  { id: 6, name: "Legal", code: "LEGAL", sortOrder: 6 },
  { id: 7, name: "Environmental", code: "ENV", sortOrder: 7 },
];
